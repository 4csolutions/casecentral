...
extend_bootinfo = "casecentral.utils.extend_bootinfo"
...
add_to_apps_screen = [
	{
		"name": "casecentral",
		"logo": "/assets/casecentral/images/logo.png",
		"title": "Case Central",
		"route": "/desk",
	}
]
...
website_route_rules = [
    {"from_route": "/case/<name>", "to_route": "case_detail"},
    {"from_route": "/matter/<name>", "to_route": "matter_detail"},
]
