...
class Case(Document):
    def on_update(self):
        ...
        if case_history:
            ...
            task_subject = f"{self.name}-Hearing-{next_hearing_date}"
            task_exists = frappe.db.exists("Task", {"subject": task_subject, "exp_start_date": next_hearing_date})
...
def get_events(start, end, filters=None):
    """Returns events for Gantt / Calendar views rendering."""
